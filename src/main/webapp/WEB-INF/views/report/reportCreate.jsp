							...
							<form action="" name="reportCreateFrm">
								<table class="font-small">
									<tbody>
										...
										<tr>
											<td>보고자</td>
											<td>
												<input type="radio" name="member" id="all" checked /><label for="all">부서원 전체</label><br />
												...
												<div id="divReportChoice" class="div-choice">
													...
													<button class="add" data-open="exampleModal1" data-type="reportChoice">+ 추가</button>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												...
												<div id="divReferenceUser" class="div-choice" style="display: inline-block;">
													...
													<button class="add" data-open="exampleModal1" data-type="referenceUser">+ 추가</button>
												</div>
												...
												<div id="divReferenceDept" class="div-choice">
													...
													<button class="add" data-open="exampleModal2" data-type="referenceDept">+ 추가</button>
												</div>
											</td>
										</tr>
										<tr>
								...
								<div class="report-no-modal reveal" id="exampleModal1" data-reveal>
									...
									<div class="font-small report-no-modal-btn">
										<button class="add-btn" data-close aria-label="Close reveal">추가</button>
									</div>
