												...
												<div class="todo-header">
													<div class="todo-header">
														...
														<form:form action="${pageContext.request.contextPath }/todo/todoContentUpdate.do" id="updateConFrm"
															class="removeView">
															<input type="text"   name="content" style="width:400px;" id="todoContentText"/>
															<input type="hidden" name="todoBoardNo" value="${todoBoard.no }" />
	...
	$('#exampleModal').foundation('open');
			$.ajax({
				...
				success(data){
					...
					summernote.innerHTML = info;   */
				 	const summernote = $("#summernote");
					summernote.html(''); // summernote 초기화
					summernote.html(info); // summernote에 값 할당  
					
					console.log(summernote.html(info));
